  ...
  <div class="container">
    ...
    <form name="login" action="login.php" method="post" accept-charset="utf-8">
      <div>
        ...
        <div>
          <input class="btn blue-grey darken-3 waves-effect waves-light login" type="submit" value="Login">
          <a class="btn blue-grey darken-3 waves-effect waves-light create" href="registerPage.php">Create Account</a>
        </div>
      </div>
    </form>
    </section>
